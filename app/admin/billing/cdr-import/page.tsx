...
export default async function CdrImportPage() {
  ...
  const rows: CdrImportBatchRow[] = batches.map((b) => ({
    ...
    customerCodeColumn: b.customerCodeColumn ?? "",
    recordTypeColumn: b.recordTypeColumn ?? "",
    ...
    distinctCustomerCodes: b.distinctCustomerCodes ?? 0,
    alertAcknowledged: Boolean(b.alertAcknowledgedAt),
    processingMs: b.processingMs ?? 0,
